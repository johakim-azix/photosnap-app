<template>
    <div class="img-grid">
        <div class="container">
            <div class="item">
                <img src="../../assets/images/desktop/mountains.jpg" alt="">
                <div class="cover">
                    <div class="caption">
                        <small>April 16th 2020</small>
            ...
            <div class="item">
                <img src="../../assets/images/desktop/cityscapes.jpg" alt="">
                <div class="cover">
                    <div class="caption">
            ...
            <div class="item">
                <img src="../../assets/images/desktop/18-days-voyage.jpg" alt="">
                <div class="cover">
                    <div class="caption">
                        <small>April 11th 2020</small>
            ...
            <div class="item">
                <img src="../../assets/images/desktop/architecturals.jpg" alt="">
                <div class="cover">
                    <div class="caption">
            ...
            <div class="item">
                ...
                <div class="cover">
                    <div class="caption">
                        <small>February 25th 2020</small>
    ...
    .img-grid{
        ...
        .item{
            ...
            &:after{
                content: "";
                display: block;
                background-image: url("../../assets/icons/img-hover-state-indicator.png");
            ...
            .cover{
                background: linear-gradient(transparent, rgba(0,0,0,.9) 90%);
                width: 100%;
                position: absolute;
                z-index: 1;
                top: 0;
